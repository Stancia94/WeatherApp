...
//тут получаем координаты города
...
function filterUsers(seacrhText, listOfUsers) {
  if (!seacrhText) {
    return listOfUsers;
  }
  return listOfUsers.filter(({ name }) => {
    name.toLowerCase().includes(seacrhText.toLowerCase());
  });
}
export default function SearchSection() {
  ...
  useEffect(() => {
    const Debounce = setTimeout(() => {
      const filteredUsers = filterUsers(searchQuery, fakeUsers);
